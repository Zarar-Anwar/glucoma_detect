# -*- coding: utf-8 -*-
"""Final Year Project  VGG16.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Vht1S6aPHawk4made22mujxBlkeec0KM
"""
...
from glucoma_detect import settings
...
IMAGE_SIZE = (100, 100)
trainDataAll = tf.keras.preprocessing.image_dataset_from_directory(
    train_dir,
...
valDataALL = tf.keras.preprocessing.image_dataset_from_directory(
    val_dir,
    label_mode="categorical",
    image_size=IMAGE_SIZE,
    shuffle=False
...
testDataALL = tf.keras.preprocessing.image_dataset_from_directory(
    test_dir,
    label_mode="categorical",
    image_size=IMAGE_SIZE,
)
...
print('Accuracy of VGG16 on Test Data:', sklearn_accuracy)
...
for i in range(6):
    ...
    plt.subplot(2, 3, i + 1)
    plt.imshow(img / 255.)
    if class_name == pred_class:  # Change the color of text based on whether the prediction is right or wrong
        title_color = "g"
    else:
        title_color = "r"
